...
const DtNode: React.FC<any> = ({ data }) => {
    return (
        <Flex
            ...
            style={{
                ...
                color: "gray",
                borderRadius: 6,
                border: `1px solid ${data.color || "#9CA1B9"}`,
            }}
        >
            <LibraryFolder />
    ...
    // return data.id !== "三级节点1-1-2" &&
    //     data.id !== "三级节点1三级节点1三级节点1-1-1" ? (
    //     <Flex
    //         align="center"
    //         gap="small"
    //         style={{
    ...
    //     >
    //         <LibraryFolder />
    //         <Typography.Text hidden={data.id === "三级节点1-1-2"}>
    //             {data.id}
    //         </Typography.Text>
    //     </Flex>
    // ) : (
    ...
    //             <ClockCircleTwoTone />
    //             <span style={{ marginLeft: "4px" }}>{data.id}</span>
    //         </Typography.Text>
    //     </Flex>
    // );
};
...
export const Demo11: React.FC = () => {
    ...
    console.log(generatePaths(treeData));
